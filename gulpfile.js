// generated on 2016-08-30 using generator-jekyllized 1.0.0-rc.5
'use strict';
...
gulp.task('inject', gulp.series('inject:head'));
...
gulp.task('deploy', gulp.series('clean', 'assets', 'build:site', 'html', 'upload'));
